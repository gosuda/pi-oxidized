...
pub struct SeqSer {
    pub items: Vec<CborValue>,
}
pub struct MapSer {
    pub entries: Vec<(String, CborValue)>,
    pub next_key: Option<CborValue>,
}
pub struct StructSer {
    pub entries: Vec<(String, CborValue)>,
}
pub struct TupleVarSer {
    pub variant: String,
    pub items: Vec<CborValue>,
}
pub struct StructVarSer {
    pub variant: String,
...
impl Serializer for CborValueSerializer {
    ...
    fn serialize_bool(self, v: bool) -> Result<CborValue, SerError> {
        Ok(CborValue::Bool(v))
    }
    fn serialize_i8(self, v: i8) -> Result<CborValue, SerError> {
        self.serialize_i64(i64::from(v))
    }
    fn serialize_i16(self, v: i16) -> Result<CborValue, SerError> {
        self.serialize_i64(i64::from(v))
    }
    ...
    fn serialize_u8(self, v: u8) -> Result<CborValue, SerError> {
        Ok(CborValue::UInt(u64::from(v)))
    }
    fn serialize_u16(self, v: u16) -> Result<CborValue, SerError> {
        Ok(CborValue::UInt(u64::from(v)))
    }
    fn serialize_u32(self, v: u32) -> Result<CborValue, SerError> {
        Ok(CborValue::UInt(u64::from(v)))
    }
    fn serialize_u64(self, v: u64) -> Result<CborValue, SerError> {
        Ok(CborValue::UInt(v))
    }
    ...
    fn serialize_char(self, v: char) -> Result<CborValue, SerError> {
        Ok(CborValue::Text(v.to_string()))
    }
    fn serialize_str(self, v: &str) -> Result<CborValue, SerError> {
        Ok(CborValue::Text(v.to_string()))
    }
    fn serialize_bytes(self, v: &[u8]) -> Result<CborValue, SerError> {
        Ok(CborValue::Bytes(v.to_vec()))
    }
    fn serialize_none(self) -> Result<CborValue, SerError> {
        Ok(CborValue::Null)
    }
    fn serialize_some<T: ?Sized + Serialize>(self, value: &T) -> Result<CborValue, SerError> {
        value.serialize(self)
    }
    fn serialize_unit(self) -> Result<CborValue, SerError> {
        Ok(CborValue::Null)
    }
    fn serialize_unit_struct(self, _name: &'static str) -> Result<CborValue, SerError> {
        Ok(CborValue::Null)
    }
...
impl SerializeSeq for SeqSer {
    ...
    fn serialize_element<T: ?Sized + Serialize>(&mut self, value: &T) -> Result<(), SerError> {
        self.items.push(value.serialize(CborValueSerializer)?);
        Ok(())
    }
...
impl SerializeMap for MapSer {
    ...
    fn serialize_key<T: ?Sized + Serialize>(&mut self, key: &T) -> Result<(), SerError> {
        self.next_key = Some(key.serialize(CborValueSerializer)?);
        Ok(())
    }
...
impl SerializeStruct for StructSer {
    ...
    fn serialize_field<T: ?Sized + Serialize>(
        ...
        self.entries
            .push((key.to_string(), value.serialize(CborValueSerializer)?));
        Ok(())
    }
    fn end(self) -> Result<CborValue, SerError> {
        Ok(CborValue::Map(self.entries))
...
pub struct CborValueDeserializer {
    pub value: CborValue,
}
...
struct MapAccess {
    iter: std::vec::IntoIter<(String, CborValue)>,
    next_value: Option<CborValue>,
}
struct EnumAccess {
    variant: String,
    value: CborValue,
...
impl<'de> serde::de::MapAccess<'de> for MapAccess {
    ...
    fn next_key_seed<K: serde::de::DeserializeSeed<'de>>(
        &mut self,
        seed: K,
    ) -> Result<Option<K::Value>, SerError> {
        match self.iter.next() {
            Some((k, v)) => {
                self.next_value = Some(v);
                Ok(Some(seed.deserialize(CborValueDeserializer {
                    value: CborValue::Text(k),
                })?))
            }
            None => Ok(None),
        }
...
impl<'de> serde::de::EnumAccess<'de> for EnumAccess {
    ...
    fn variant_seed<T: serde::de::DeserializeSeed<'de>>(
        self,
        seed: T,
    ) -> Result<(T::Value, Self::Variant), SerError> {
        let de = serde::de::value::StrDeserializer::new(&self.variant);
        Ok((
            seed.deserialize(de)?,
            CborValueDeserializer { value: self.value },
        ))
    }
}
...
impl<'de> Deserializer<'de> for CborValueDeserializer {
    ...
    fn deserialize_any<V: serde::de::Visitor<'de>>(self, visitor: V) -> Result<V::Value, SerError> {
        match self.value {
            ...
            CborValue::Array(a) => {
                let mut sa = SeqAccess {
                    iter: a.into_iter(),
                };
                visitor.visit_seq(&mut sa)
            }
            CborValue::Map(e) => {
                let mut ma = MapAccess {
                    iter: e.into_iter(),
                    next_value: None,
                };
    ...
    fn deserialize_bool<V: serde::de::Visitor<'de>>(self, v: V) -> Result<V::Value, SerError> {
        match self.value {
            CborValue::Bool(b) => v.visit_bool(b),
            _ => Err(SerError::custom("expected bool")),
        }
    }
    fn deserialize_i8<V: serde::de::Visitor<'de>>(self, v: V) -> Result<V::Value, SerError> {
        self.deserialize_i64(v)
    }
    fn deserialize_i16<V: serde::de::Visitor<'de>>(self, v: V) -> Result<V::Value, SerError> {
        self.deserialize_i64(v)
    }
    ...
    fn deserialize_u8<V: serde::de::Visitor<'de>>(self, v: V) -> Result<V::Value, SerError> {
        self.deserialize_u64(v)
    }
    fn deserialize_u16<V: serde::de::Visitor<'de>>(self, v: V) -> Result<V::Value, SerError> {
        self.deserialize_u64(v)
    }
    fn deserialize_u32<V: serde::de::Visitor<'de>>(self, v: V) -> Result<V::Value, SerError> {
        self.deserialize_u64(v)
    }
    fn deserialize_u64<V: serde::de::Visitor<'de>>(self, v: V) -> Result<V::Value, SerError> {
        match self.value {
            CborValue::UInt(n) => v.visit_u64(n),
            _ => Err(SerError::custom("expected u64")),
        }
    }
    ...
    fn deserialize_f64<V: serde::de::Visitor<'de>>(self, v: V) -> Result<V::Value, SerError> {
        match self.value {
            ...
            CborValue::UInt(n) => v.visit_f64(n as f64),
            CborValue::NInt(n) => v.visit_f64(n as f64),
            _ => Err(SerError::custom("expected f64")),
        }
    }
    fn deserialize_char<V: serde::de::Visitor<'de>>(self, v: V) -> Result<V::Value, SerError> {
        self.deserialize_str(v)
    }
    fn deserialize_str<V: serde::de::Visitor<'de>>(self, v: V) -> Result<V::Value, SerError> {
        self.deserialize_string(v)
    }
    fn deserialize_string<V: serde::de::Visitor<'de>>(self, v: V) -> Result<V::Value, SerError> {
        match self.value {
            CborValue::Text(s) => v.visit_string(s),
            _ => Err(SerError::custom("expected string")),
        }
    }
    fn deserialize_bytes<V: serde::de::Visitor<'de>>(self, v: V) -> Result<V::Value, SerError> {
        self.deserialize_byte_buf(v)
    }
    fn deserialize_byte_buf<V: serde::de::Visitor<'de>>(self, v: V) -> Result<V::Value, SerError> {
        match self.value {
            CborValue::Bytes(b) => v.visit_byte_buf(b),
            _ => Err(SerError::custom("expected bytes")),
        }
    }
    fn deserialize_option<V: serde::de::Visitor<'de>>(self, v: V) -> Result<V::Value, SerError> {
        match self.value {
            CborValue::Null => v.visit_none(),
            _ => v.visit_some(self),
        }
    }
    fn deserialize_unit<V: serde::de::Visitor<'de>>(self, v: V) -> Result<V::Value, SerError> {
        match self.value {
            CborValue::Null => v.visit_unit(),
            _ => Err(SerError::custom("expected unit")),
        }
    }
    ...
    fn deserialize_seq<V: serde::de::Visitor<'de>>(self, v: V) -> Result<V::Value, SerError> {
        match self.value {
            ...
            _ => Err(SerError::custom("expected array")),
        }
    }
    ...
    fn deserialize_map<V: serde::de::Visitor<'de>>(self, v: V) -> Result<V::Value, SerError> {
        match self.value {
            ...
            _ => Err(SerError::custom("expected map")),
        }
    }
            ...
            CborValue::Map(e) => {
                if e.len() == 1 {
                    let (var, val) = e
                        .into_iter()
                        .next()
                        .ok_or_else(|| SerError::custom("empty"))?;
                    ...
                    Err(SerError::custom(
                        "externally tagged enum must have one entry",
                    ))
                }
            }
...
impl<'de> serde::de::VariantAccess<'de> for CborValueDeserializer {
    ...
    fn unit_variant(self) -> Result<(), SerError> {
        match self.value {
            CborValue::Null => Ok(()),
            _ => Err(SerError::custom("expected unit variant")),
        }
    }
    fn newtype_variant_seed<T: serde::de::DeserializeSeed<'de>>(
        self,
        seed: T,
    ) -> Result<T::Value, SerError> {
