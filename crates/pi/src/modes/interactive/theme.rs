...
pub fn make_fg(color: ThemeColor) -> fn(&str) -> String {
    match color {
        ...
        ThemeColor::ScrollbarTrack => |s| current().fg(ThemeColor::Text, s),
        ThemeColor::ScrollbarThumb => |s| current().fg(ThemeColor::Text, s),
        ThemeColor::SearchMatchText => |s| current().fg(ThemeColor::Text, s),
