...
The shared arbitration oracle is exactly six `AgentLoopConfig` literal sites: `crates/pi-agent/src/agent.rs:65-93`, `crates/pi-agent/src/config.rs:439-477`, `crates/pi-agent/src/run.rs:1251-1280`, `crates/pi-agent/src/schedule.rs:957-985`, `crates/pi/src/core/agent_session/mod.rs:472-500`, and `crates/pi-agent/src/bin/pi_agent_stream_frame_bench.rs:267-295`.
