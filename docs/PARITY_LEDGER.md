...
| A8 | Upstream ./compat legacy global provider registry | pi-ai | auth/config_value.rs or deletion ledger | compatibility audit | parity-blocked | Evidence checklist: upstream export map; upstream source surface; downstream importer corpus; extension-host routing; executable negative witnesses. |
