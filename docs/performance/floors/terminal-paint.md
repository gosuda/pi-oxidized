...
- Consumers: interactive repaint (runtime.rs:4527), stream partial paints (coalescer <=16 ms, runtime.rs:4613-4616), keypress immediate repaints (runtime.rs:2157-2159).
