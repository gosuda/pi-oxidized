...
- Canonical authority `.references/pi-2.0/packages/protocol/src/framing.ts:1-165` (at `853a80d26c90a14c1886f0ebb8ffaae133ca2185`): `FRAME_HEADER_LENGTH = 4`, `DEFAULT_MAX_FRAME_LENGTH = 16 * 1024 * 1024`, big-endian `length >>> 24/16/8/0` prefix, and `FrameDecoder` (lines 58-165) with incremental split and configured limit rejection.
