...
export const COMPATIBILITY_VERSION = "0.80.10" as const;
...
export function isMethod(raw: string): raw is Method {
...
export function localHello(): Hello {
	return {
...
export function localHelloAck(): HelloAck {
	return {
		protocolVersion: PROTOCOL_VERSION,
		compatibilityVersion: COMPATIBILITY_VERSION,
	};
